...
db.serialize(() => {
    ...
    db.get("SELECT COUNT(*) as c FROM emergency_protocols", (err, row) => {
        ...
        const protocols = [
            ...
            ['All Regions','Police Emergency','security','Theft, assault, or security incidents.','102','["Call 102 (police emergency)","Note the officer\'s name and badge number","File an official written police report — REQUIRED for insurance claims","Contact your embassy if the response feels inadequate","US Embassy 24hr: +996 312 551 241 | UK Embassy: +996 312 303 037"]',8],
            ['All Regions','Embassy Contacts','diplomatic','Document loss, arrest, or critical incidents requiring diplomatic assistance.','',"[\"US Embassy Bishkek: +996 312 551 241 (24hr emergency line)\",\"UK Embassy Bishkek: +996 312 303 037\",\"German Embassy Bishkek: +996 312 905 000\",\"French Embassy Bishkek: +996 312 623 402\",\"Swiss Embassy (via Kazakhstan): +7 727 258 2600\",\"Lost passport: contact embassy immediately for emergency travel document\",\"Allow 2–5 working days for emergency passport processing\"]",9],
